...
get_header(); ?>
    ...
    <section id="primary">
      ...
      <?php if ( have_posts() ) : ?>
        ...
        <?php if ( of_get_option('basestation_content_nav_above') ) { basestation_content_nav( 'nav-above' ); } ?>
        ...
        <?php endwhile; ?>
      <?php if ( of_get_option('basestation_content_nav_below',1) ) { basestation_content_nav( 'nav-below' ); } ?>
